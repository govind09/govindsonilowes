...
public class ArithmeticOperationController  {
    ...
    @GetMapping("/add/{a}/{b}")
    public String add(@PathVariable("a") BigDecimal a, @PathVariable("b") BigDecimal b) {
        return operationService.add(a, b);
    }


    @GetMapping("/mul/{a}/{b}")
    public String multiply(@PathVariable("a") BigDecimal a, @PathVariable("b") BigDecimal b) {
        return operationService.mul(a, b);
    }

    @GetMapping("/sub/{a}/{b}")
    public String sub(@PathVariable("a") BigDecimal a, @PathVariable("b") BigDecimal b) {
        return operationService.sub(a, b);
    }

    @GetMapping("/div/{a}/{b}")
    public String divide(@PathVariable("a") BigDecimal a, @PathVariable("b") BigDecimal b) {
